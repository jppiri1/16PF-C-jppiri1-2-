...
# 아래의 내용은 이 .py 파일이impore 될 떄는 실행되지 않음
if '__main__' == __name__:
    ...
    # CashcCard.py 모듈 안의 balance_won 값을 반환
    chk_bal("입금 후 잔고 확인", CashCard_module)

    print("1000원 출금")
    # CashCard.py 모듈 안의 whitdraw() 함수를 호출
    # CashCard.py 모듈의 balance_won 값이 감소
    CashCard_module.whitdraw(1000)
    ...
    chk_bal("CashCard_module 잔액확인", CashCard_module)
    chk_bal("mySistersCard_module 작액 확인", mySistersCard_module)

    # 그러나 이런식으로는 한 장의 카드만 만들 수 있다
